...
public class ProductDetailPage extends BrowserUtility {
    ...
    private static final By SIZE_DROP_DOWN_LOCATOR = By.xpath("//div[@id='uniform-group_1']/select/option");
    ...
    public ProductDetailPage changeSize(Size size) {
        selectFromDropdownOptions(SIZE_DROP_DOWN_LOCATOR, size.toString());
